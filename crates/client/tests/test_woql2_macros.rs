...
use terminusdb_schema::{EntityIDFor, ToJson, ToTDBInstance};
...
async fn setup_test_schemas(
    client: &TerminusDBHttpClient,
    spec: &BranchSpec,
) -> anyhow::Result<()> {
    let args = DocumentInsertArgs::from(spec.clone());
    client
        .insert_entity_schema::<Document>(args.clone())
        .await?;
    client.insert_entity_schema::<User>(args.clone()).await?;
    client
        .insert_entity_schema::<Subscription>(args.clone())
        .await?;
...
async fn test_starts_with_macro() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_starts_with", |client, spec| async move {
            ...
            assert_eq!(
                ...
                2,
                "Should find 2 documents starting with 'DOC-'"
            );
...
async fn test_ends_with_macro() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_ends_with", |client, spec| async move {
            setup_test_schemas(&client, &spec).await?;
            ...
            assert_eq!(
                results.bindings.len(),
                2,
                "Should find 2 users with @company.com email"
            );
...
async fn test_contains_macro() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_contains", |client, spec| async move {
            setup_test_schemas(&client, &spec).await?;
            ...
            let docs = vec![
                ...
                Document {
                    ...
                    content: "This contains important technical specifications and guidelines."
                        .to_string(),
            ...
            assert_eq!(
                results.bindings.len(),
                2,
                "Should find 2 documents containing 'important'"
            );
...
async fn test_today_macro() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_today", |client, spec| async move {
            setup_test_schemas(&client, &spec).await?;
            ...
            let today_str = match today_value {
                ...
                other => panic!(
                    "today! should return a Data DateTime value, got {:?}",
                    other
                ),
            };
            ...
            let debug_results: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(Some(spec.clone()), debug_json, None)
                .await?;
            ...
            assert!(
                results.bindings.len() >= 1,
                "Should find at least one document created today"
            );
...
async fn test_after_before_macros() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_after_before", |client, spec| async move {
            setup_test_schemas(&client, &spec).await?;
            ...
            let results_after: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(Some(spec.clone()), json_query, None)
                .await?;
            ...
            let results_before: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(Some(spec.clone()), json_query, None)
                .await?;
            ...
            assert_eq!(
                results_before.bindings.len(),
                2,
                "Should find 2 events before 2025-01-01"
            );
...
async fn test_in_between_macro() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_in_between", |client, spec| async move {
            setup_test_schemas(&client, &spec).await?;
...
async fn test_today_in_between_macro() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_today_in_between", |client, spec| async move {
            setup_test_schemas(&client, &spec).await?;
            ...
            let query = select!(
                [sub_id, name, start_date, end_date],
                and!(
...
async fn test_compare_macro_operators() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_compare", |client, spec| async move {
            setup_test_schemas(&client, &spec).await?;
            ...
            let all_results: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(
                    Some(spec.clone()),
                    all_events_query.to_instance(None).to_json(),
                    None,
                )
                .await?;
            ...
            let results_gt: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(
                    Some(spec.clone()),
                    query_gt.to_instance(None).to_json(),
                    None,
                )
                .await?;
            ...
            assert_eq!(
                results_gt.bindings.len(),
                1,
                "Should find 1 event with >50 attendees"
            );
            ...
            let results_lt: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(
                    Some(spec.clone()),
                    query_lt.to_instance(None).to_json(),
                    None,
                )
                .await?;
            ...
            let results_gte: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(
                    Some(spec.clone()),
                    query_gte.to_instance(None).to_json(),
                    None,
                )
                .await?;
            ...
            assert_eq!(
                results_gte.bindings.len(),
                3,
                "Should find 3 events with >=50 attendees"
            );
            ...
            let results_eq: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(
                    Some(spec.clone()),
                    query_eq.to_instance(None).to_json(),
                    None,
                )
                .await?;
            ...
            assert_eq!(
                results_eq.bindings.len(),
                2,
                "Should find 2 events with exactly 50 attendees"
            );
            ...
            let results_ne: WOQLResult<HashMap<String, serde_json::Value>> = client
                .query_raw(
                    Some(spec.clone()),
                    query_ne.to_instance(None).to_json(),
                    None,
                )
                .await?;
            ...
            assert_eq!(
                results_ne.bindings.len(),
                3,
                "Should find 3 events with status != 'scheduled'"
            );
...
async fn test_complex_query_with_multiple_macros() -> anyhow::Result<()> {
    ...
    server
        .with_tmp_db("test_complex", |client, spec| async move {
            setup_test_schemas(&client, &spec).await?;
            ...
            let docs = vec![
                Document {
                    ...
                    content: "This document contains important security findings from last month."
                        .to_string(),
            ...
            let query = select!(
                [doc_id, title, content, created_date],
                and!(
                    type_!(var!(doc), "@schema:Document"),
                    triple!(var!(doc), "@schema:id", var!(doc_id)),
                    triple!(var!(doc), "title", var!(title)),
            ...
            assert_eq!(
                results.bindings.len(),
                0,
                "Should find 0 documents matching all criteria"
            );
