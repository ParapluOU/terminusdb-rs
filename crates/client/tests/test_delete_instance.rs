...
mod tests {
    ...
    /// Helper to setup schema in a database
    ...
    async fn test_delete_instance() -> anyhow::Result<()> {
        ...
        server
            .with_tmp_db("test_delete", |client, spec| async move {
    ...
    async fn test_delete_instance_by_id() -> anyhow::Result<()> {
        ...
        server
            .with_tmp_db("test_delete_by_id", |client, spec| async move {
                setup_schema(&client, &spec).await?;
    ...
    async fn test_delete_document_untyped() -> anyhow::Result<()> {
        ...
        server
            .with_tmp_db("test_delete_doc", |client, spec| async move {
                setup_schema(&client, &spec).await?;
    ...
    async fn test_delete_nonexistent_instance() -> anyhow::Result<()> {
        ...
        server
            .with_tmp_db("test_delete_nonexistent", |client, spec| async move {
                setup_schema(&client, &spec).await?;
    ...
    async fn test_delete_multiple_instances() -> anyhow::Result<()> {
        ...
        server
            .with_tmp_db("test_delete_multi", |client, spec| async move {
                setup_schema(&client, &spec).await?;
