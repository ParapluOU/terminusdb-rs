...
mod tests {
    ...
    async fn test_schemas_macro() -> anyhow::Result<()> {
        ...
        server
            .with_tmp_db("test_schemas_macro", |client, spec| async move {
    ...
    async fn test_insert_schemas_tuple() -> anyhow::Result<()> {
        ...
        server
            .with_tmp_db("test_insert_schemas_tuple", |client, spec| async move {
    ...
    async fn test_schemas_macro_empty() -> anyhow::Result<()> {
        ...
        // Test empty macro (no database needed)
    ...
    async fn test_mixed_approaches_comparison() -> anyhow::Result<()> {
        ...
        server
            .with_tmp_db("test_mixed_approaches", |client, spec| async move {
