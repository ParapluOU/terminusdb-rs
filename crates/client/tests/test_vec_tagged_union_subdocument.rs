...
async fn test_vec_tagged_union_subdocument_insert_and_retrieve() -> Result<()> {
    ...
    server.with_tmp_db("test_vec_subdoc", |client, spec| async move {
        // Insert schemas
...
async fn test_empty_vec_tagged_union_subdocument() -> Result<()> {
    ...
    server.with_tmp_db("test_empty_vec", |client, spec| async move {
        // Insert schemas
        let args = DocumentInsertArgs::from(spec.clone());
        client.insert_entity_schema::<Person>(args.clone()).await?;
...
async fn test_single_variant_vec() -> Result<()> {
    ...
    server.with_tmp_db("test_single_variant", |client, spec| async move {
        // Insert schemas
        let args = DocumentInsertArgs::from(spec.clone());
        client.insert_entity_schema::<Person>(args.clone()).await?;
...
async fn test_hashset_tagged_union_subdocument() -> Result<()> {
    ...
    server.with_tmp_db("test_hashset_subdoc", |client, spec| async move {
        // Insert schemas
        let args = DocumentInsertArgs::from(spec.clone());
...
async fn test_btreeset_tagged_union_subdocument() -> Result<()> {
    ...
    server.with_tmp_db("test_btreeset_subdoc", |client, spec| async move {
        // Insert schemas
        let args = DocumentInsertArgs::from(spec.clone());
