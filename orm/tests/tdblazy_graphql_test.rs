...
async fn test_tdblazy_schema_creates_link() -> anyhow::Result<()> {
    with_test_db("tdblazy_schema_test", |client, spec| async move {
        // Insert schemas
...
async fn test_tdblazy_forward_relation() -> anyhow::Result<()> {
    with_test_db("tdblazy_forward_test", |client, spec| async move {
        // Insert schemas
        let args = DocumentInsertArgs::from(spec.clone());
        client.insert_entity_schema::<Writer>(args).await?;
...
async fn test_tdblazy_reverse_relation() -> anyhow::Result<()> {
    with_test_db("tdblazy_reverse_test", |client, spec| async move {
        // Insert schemas
        let args = DocumentInsertArgs::from(spec.clone());
        client.insert_entity_schema::<Writer>(args).await?;
...
async fn test_orm_with_relation_loads_children() -> anyhow::Result<()> {
    with_test_db("orm_with_relation_test", |client, spec| async move {
        // Insert schemas
        let args = DocumentInsertArgs::from(spec.clone());
        client.insert_entity_schema::<Writer>(args).await?;
